...
export const get = (http, params, headers) => {
  return raw.get(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/ai/agents/runs/${params.runId}`, {
    headers: _objectSpread(_objectSpread({}, AgentRunAlphaHeaders), headers)
  });
};
export const getMany = (http, params, headers) => {
  return raw.get(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/ai/agents/runs`, {
    params: params.query,
    headers: _objectSpread(_objectSpread({}, AgentRunAlphaHeaders), headers)
  });
};