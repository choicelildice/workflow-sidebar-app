...
export type PlainClientAPI = {
    ...
    contentType: {
        ...
        getManyWithCursor(params: OptionalDefaults<GetSpaceEnvironmentParams & CursorBasedParams>): Promise<CursorPaginatedCollectionProp<ContentTypeProps>>;
    ...
    entry: {
        ...
        getManyWithCursor<T extends KeyValueMap = KeyValueMap>(params: OptionalDefaults<GetSpaceEnvironmentParams & CursorBasedParams & {
            releaseId?: string;
    ...
    asset: {
        ...
        getManyWithCursor(params: OptionalDefaults<GetSpaceEnvironmentParams & CursorBasedParams & {
            releaseId?: string;
