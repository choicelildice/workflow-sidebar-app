import { ContentType, EditorInterface, SpaceMembership, Role, ContentTypeField, Metadata, Entry, Task, Asset, Release, WorkflowDefinition } from './entities';
...
export type AgentAppSDK<InstallationParameters extends KeyValueMap = KeyValueMap> = BaseAppSDK<InstallationParameters, never, never> & {
    agent: AgentAPI;
    /** Methods to update the size of the iframe the app is contained within.  */
    window: WindowAPI;
};
